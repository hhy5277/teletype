...
class GuestPortalBinding {
  ...
  // last editor has been removed from portal => empty
  // remove editor that's not the last editor
  // add new editor
  //   variants: guest has it open; guest does not have it open
  // focus an editor that was already part of the portal
  //   variants: guest has it open; guest does not have it open
  ...
  async setActiveEditorProxy (editorProxy) {
    this.lastSetActiveEditorProxyPromise = this.lastSetActiveEditorProxyPromise.then(async () => {
      if (editorProxy == null) {
        if (this.shouldShowEmptyPortalPaneItem()) {
  ...
  async openPaneItem (newActivePaneItem) {
    ...
    if (this.activePaneItem instanceof EmptyPortalPaneItem) {
